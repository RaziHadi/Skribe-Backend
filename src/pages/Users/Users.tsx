...
const Users = () => {
    ...
    useEffect(() => {
        userService.getAgencyUsersById(customerId)
          .then(response => {     
    ...
    const [initialRecords, setInitialRecords] = useState(sortBy(rowData, 'userName'));
    ...
    const [hideCols, setHideCols] = useState<any>(['emailSignature', 'state']);
    ...
    const cols = [
        ...
        { accessor: 'agencyName', title: 'Agency Name' },
        { accessor: 'userName', title: 'User Name' },
        { accessor: 'email', title: 'Email' },
        { accessor: 'status', title: 'Status' },
        { accessor: 'emailConfirmed', title: 'Email Confirmed' },
        { accessor: 'phoneNumber', title: 'Phone' },
        { accessor: 'state', title: 'State' },
        { accessor: 'city', title: 'City' },
        { accessor: 'emailSignature', title: 'emailSignature' },
    ...
    //#region Start Export
    const col = ['id', 'agencyName', 'userName', 'email', 'status', 'emailConfirmed', 'phoneNumber', 'state','city','emailSignature'];
    const header = ['Id', 'AgencyName', 'userName', 'Email', 'Status', 'emailConfirmed', 'phoneNumber', 'state','city','emailSignature'];
    ...
    return (
        <div>
            <div className="panel">
                ...
                <h5 className="font-semibold text-lg dark:text-white-light">Users of {rowData[0].agencyName}</h5>
                    ...
                    <DataTable
                        ...
                        columns={[
                            { accessor: 'id', title: 'ID', sortable: true, hidden: hideCols.includes('id') },
                            {
                                ...
                                title: 'Agency Name',
                                sortable: true,
                                hidden: hideCols.includes('agencyName'),
                            },
                            {
                                accessor: 'userName',
                                title: 'User Name',
                            ...
                            { accessor: 'phoneNumber', title: 'Phone', sortable: true, hidden: hideCols.includes('phoneNumber') },
                            {
                                accessor: 'emailConfirmed',
                                title: 'Email Confirmed',
                                sortable: true,
                                hidden: hideCols.includes('emailConfirmed'),
                                render: ({ emailConfirmed }) => <div className={`${emailConfirmed ? 'text-success' : 'text-danger'} capitalize`}>{emailConfirmed.toString()}</div>,
                            },
                            {
                                accessor: 'state',
                                title: 'State',
                            ...
                            },
                            {
                                ...
                                render: ({ status }) => <div className={`${status ? 'text-success' : 'text-danger'} capitalize`}>{status.toString()}</div>,
                            },
                            {
                                accessor: 'emailSignature',
                                title: 'Email Signature',
                                sortable: true,
                                hidden: hideCols.includes('emailSignature'),
