...
const LoginBoxed = () => {
    ...
    const submitForm = (e:any) => {
        e.preventDefault();
        setSubmitting(true);
        AuthService.login(cred.username, cred.password).then(
            () => {                       
                setSubmitting(false);         
                navigate('/Index');
                Alert.success("toast","Login")
            },
            (error:any) => {
              const resMessage =
                (error.response &&
            ...
            <div className="panel sm:w-[480px] m-6 max-w-lg w-full">
                ...
                ref={c => {
                    ...
                    <div>
                        ...
                        <input onChange={onChangeUsername} id="email" type="text" className="form-input" placeholder="Enter Email" />
                    </div>
                    <div>
                        <label htmlFor="password">Password</label>
                        <input onChange={onChangePassword} id="password" type="password" className="form-input" placeholder="Enter Password" />
                    </div>
                    <div>
