...
const Registration = lazy(() => import('../pages/Users/Userregistration'));
const CreateCustomer = lazy(() => import('../pages/Users/CreateCustomer'));
const AllCustomer = lazy(() => import('../pages/Users/AllCustomer'));
const EditCustomer = lazy(() => import('../pages/Users/EditCustomer'));
const AgencyUsers = lazy(() => import('../pages/Users/Users'));
const Preferences = lazy(() => import('../pages/Settings/Preferences'));
const MediaType = lazy(() => import('../pages/Settings/MediaType'));
const routes = [

    {
        path: '/users/Clients-Users?/:id',
        element: <AgencyUsers />,
    },
    {
