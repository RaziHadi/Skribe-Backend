                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                    <li>
                                            <NavLink to="/users/AllCustomer">{t('All Customer')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/users/Create-Customer">{t('Create Customer')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/users/Registration">{t('User Registration')}</NavLink>
                                        </li>
                                        <li>
